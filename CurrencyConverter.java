...
b1.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
        ...
        double roundedValue = Math.round(d1 * 100.0) / 100.0;

        // Getting the string value of the calculated rounded value
        String str1 = String.format("%.2f", roundedValue);
...
b2.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
        ...
        // Rounding to 2 decimal places
        double roundedValue = Math.round(d3 * 100.0) / 100.0;

        // Getting the string value of the calculated rounded value
        String str2 = String.format("%.2f", roundedValue);
